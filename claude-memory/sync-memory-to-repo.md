...
For the COMP9313 private repo (and similar personal private repos), keep a copy of the Claude Code memory files inside the repo so the user can carry CC's prior memory across platforms.
...
See [[comp9313-repo]] and [[solution-file-convention]].
