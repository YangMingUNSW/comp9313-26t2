...
description: Commit and push to GitHub after every code/file change in the COMP9313 repo
metadata:
  node_type: memory
  type: feedback
---

In the COMP9313 repo (and the user's similar personal repos), after every change to
...
distinct changes. See [[comp9313-repo]] and [[sync-memory-to-repo]].
